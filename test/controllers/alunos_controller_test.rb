...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { cpf: @aluno.cpf, date_of_birth: @aluno.date_of_birth, email: @aluno.email, name: @aluno.name, ra: @aluno.ra } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { cpf: @aluno.cpf, date_of_birth: @aluno.date_of_birth, email: @aluno.email, name: @aluno.name, ra: @aluno.ra } }
